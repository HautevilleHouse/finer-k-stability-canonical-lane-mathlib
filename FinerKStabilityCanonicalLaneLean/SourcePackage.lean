/-!
# Source package model for `finer-k-stability-canonical-lane`
...
def sourceCheckoutHead : String := "d4b076cc354e4613b1a37980e305a5b6a33e6097"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/fks_closure_guard.py", sha256 := "db9a9c07d90effe61c156065da4d3b009728a2f5f9ac219c4bc4a9befe6a9579", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/fks_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 31, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 35, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 40, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 46, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 58, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 75, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 86, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 119, isAsync := false },
  { file := "scripts/fks_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 126, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/fks_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/fks_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/fks_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_stability\", \"sigma_testconfig\", \"kappa_compact\", \"rho_rigidity\", \"stability_lock\"]", line := 21 },
  { file := "scripts/fks_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 28 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_stability", status := "derived_numeric", formula := "c_core_raw * density_raw - e_core_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["c_core_raw", "density_raw", "e_core_raw"] },
  { group := "constants", key := "sigma_testconfig", status := "derived_numeric", formula := "capture_floor_raw - transport_loss_raw - restart_loss_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["capture_floor_raw", "restart_loss_raw", "transport_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "stability_lock", status := "derived_numeric", formula := "c_transfer_raw * transfer_gain_raw - e_transfer_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_positive", componentKeys := ["c_transfer_raw", "e_transfer_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" },
  { key := "k-stability_transfer", value := "1.0305400000000002", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#k-stability_transfer", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 6.2 / Appendix E.4" },
  { key := "kappa_canonical", value := "1.093874", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_canonical", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "kappa_compact", value := "0.8038585209003215", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" },
  { key := "kappa_stability", value := "1.091838", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_stability", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" },
  { key := "rho_rigidity", value := "1.077", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" },
  { key := "sigma_degeneration", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_degeneration", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 5.2 / Appendix B" },
  { key := "sigma_testconfig", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_testconfig", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" },
  { key := "stability_lock", value := "1.02951", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#stability_lock", sourceSection := "paper/FINER_K_STABILITY_PREPRINT.md Section 3" }
]
