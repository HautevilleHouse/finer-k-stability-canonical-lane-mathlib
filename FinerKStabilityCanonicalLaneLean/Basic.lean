/-!
# finer-k-stability-canonical-lane Lean migration boundary
...
`FinerKStabilityCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "finer-k-stability-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/finer-k-stability-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Finer K-Stability: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "local-to-global", "manifold-constrained", "k-stability", "test-configurations", "complex-geometry", "mathematical-proof", "reproducibility"]
