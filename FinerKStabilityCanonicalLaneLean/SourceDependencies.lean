...
/-!
# Source dependency model for `finer-k-stability-canonical-lane`
...
def sourceImportDependencies : List SourceImportDependency := [
  ...
  { file := "scripts/fks_closure_guard.py", kind := "from_import", module := "__future__", name := "annotations", alias := "", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "import", module := "argparse", name := "", alias := "", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "import", module := "datetime", name := "", alias := "dt", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "import", module := "json", name := "", alias := "", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "import", module := "math", name := "", alias := "", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "from_import", module := "pathlib", name := "Path", alias := "", level := 0 },
  { file := "scripts/fks_closure_guard.py", kind := "from_import", module := "typing", name := "Any", alias := "", level := 0 },
...
def sourcePathDependencies : List SourcePathDependency := [
  ...
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_REGISTRY", path := "artifacts/constants_registry.json", role := "artifact", line := 16 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_STITCH", path := "artifacts/stitch_constants.json", role := "artifact", line := 17 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_OUT", path := "repro/certificate_runtime.json", role := "repro", line := 18 },
  { file := "scripts/fks_closure_guard.py", name := "DEFAULT_HISTORY", path := "repro/drift_guard_runs.jsonl", role := "repro", line := 19 },
