# Finer K Stability — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/finer-k-stability-canonical-lane-mathlib.git
cd finer-k-stability-canonical-lane-mathlib
lake exe
lake build
```
